...
import { createProveedor } from '@/app/lib/actions';
...
export default function CreateProveedorForm({
  requerimientoId,
  customerId = '',
  siteId = '',
  ...
  return (
    <form action={action}>
      <input type="hidden" name="idRequerimientos" value={requerimientoId} />
      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6 grid grid-cols-1 gap-4 md:grid-cols-2 text-xs">
        ...
        <div>
          <label htmlFor="CUIT" className="mb-1 block font-medium">CUIT</label>
          <input id="CUIT" name="CUIT" type="text" className="block w-full rounded-md border border-gray-200 p-2" />
        </div>
        <div>
