...
import { fetchRequerimientoById, fetchSiteById, fetchCustomerById } from '@/app/lib/data';
  ...
  return (
    <main className="p-6 space-y-4">
      ...
      <div className="flex gap-4">
        ...
        <Link href={`/dashboard/manager/sites/requerimientos?siteId=${siteId}&customerId=${customerId}`} className="underline">Crear Requerimiento</Link>
      </div>
    </main>
  );
}