  ...
  return (
    <main className="p-6 space-y-4">
      ...
      <div className="flex gap-4">
        <RefreshLink href="/dashboard/customersSICC" className="underline">
          Volver
        </RefreshLink>
        <RefreshLink
          href={`/dashboard/customersSICC/sites?customerId=${customerId}`}
          className="underline"
        >
          Crear nuevo Site
        </RefreshLink>
        <RefreshLink
          href={`/dashboard/customersSICC/sites/requerimientos?siteId=${id}`}
          className="underline"
        >
          Crear Requerimiento
        </RefreshLink>
